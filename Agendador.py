...
#################### formatando tela a direita para cadastro Usuario ###################
        self.frame_cima = Frame(self.janela, width=310, height=50, bg=c01, relief='flat') ### faixa_cadastro
        #img = PhotoImage(file="imagem/logo.png")
        #self.l_imagem = Label(self.janela,image=img).grid()
        #self.l_imagem.place(x=10, y=10)
        #self.frame_cima.grid(row=0, column=0) ###frame.cima

        self.frame_baixo = Frame(self.janela, width=310, height=403, bg=c01, relief='flat') ### tela_cadastro
...
################ formatando tela a esquerda para apresentar a Tabela  ###############
        self.frame_direita= Frame(self.janela, width=588, height=403, bg=c01, relief='flat') ### tela_apresenta
    ...
    def botoes_padroes(self):
        ...
        self.b_agendar = Button(self.frame_baixo,command=agenda, text='Agendar',  width =10, font=('Ivy 9 bold'),bg=c02,fg=c01,bd=3, relief='raised', overrelief='ridge')
...
class usuario():
    ...
    #################### formatando tela a direita para cadastro Usuario ###################
        self.frame_cima = Frame(self.janela, bd=4, width=310, height=50, bg=c03, relief='flat') ### faixa_cadastro
        self.frame_cima.grid(row=0, column=0) ###frame.cima
        ############### Inserindo formulario de Usuario ###############
        self.titulo_u = Label(janela, text='Formulário',anchor=NW, font=('Ivy 13 bold'), bg=c03,fg=c01, relief='flat')
        ...
        self.b_salvar = Button(janela,command=self.up_date, text='Salvar', width =10, font=('Ivy 9 bold'),bg=c09,fg=c08,bd=3, relief='raised', overrelief='ridge')
        self.b_salvar.place(x=210, y=350)
    ...
    ##### atualizar tabela #####
        ...
        if (nome == '') or (logradouro == '') or (num == '') or (bairro == '') or (cep == '') or (cidade == '') or (estado == '') or (idade == '') or (genero == '') or (telefone == '') or (cpf == '') or (email == ''):
            messagebox.showerror('Erro', 'Nenhum campo não pode ser vazio!')

        
        elif idade <= 17:
            messagebox.showerror('Erro', 'Cadastro apenas para Maiores de 18 anos!')
    ...
    def atualizar_tabela(self):
        try:
            ...
            self.tree_lista = treev_dicionario['values']

            valor_id = self.tree_lista[0]
            ...
            self.e_nome.insert(0, self.tree_lista[1])
            self.e_logra.insert(0, self.tree_lista[2])
            self.e_num.insert(0, self.tree_lista[3])
            self.e_bairro.insert(0, self.tree_lista[4])
            self.e_cep.insert(0, self.tree_lista[5])
            self.e_cid.insert(0, self.tree_lista[6])
            self.e_estado.insert(0, self.tree_lista[7])
            self.e_idade.insert(0, self.tree_lista[8])
            self.e_gen.insert(0, self.tree_lista[9])
            self.e_tel.insert(0, self.tree_lista[10])
            self.e_cpf.insert(0, self.tree_lista[11])
            self.e_email.insert(0, self.tree_lista[12])
...
class evento():
    ...
    def tela_evento(self):
        #################### formatando tela a direita para cadastro Usuario ###################
        self.frame_cima = Frame(self.janela, bd=4, width=310, height=50, bg=c06, relief='flat') ### faixa_cadastro
        self.frame_cima.grid(row=0, column=0) ###frame.cima
        ############### Inserindo formulario de Usuario ###############
        self.titulo_u = Label(janela, text='Evento',anchor=NW, font=('Ivy 13 bold'), bg=c06,fg=c01, relief='flat')
        self.titulo_u.place(x=10, y=10)  
    ...
    def formulario_evento(self):  
        ...
        self.e_data = Entry(janela,  width=12, background='darkblue', foreground='white', borderwidth=2)
        self.e_data.place(x=15, y=110)

        self.l_cid = Label(janela, text='Cidade*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_cid.place(x=110, y=90)
        self.e_cid = Entry(janela, width =22,justify='left',relief='solid')
        self.e_cid.place(x=115, y=110)

        self.l_estado = Label(janela, text='Estado*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_estado.place(x=259, y=90)
        self.e_estado = Entry(janela, width =5,justify='left',relief='solid')
        self.e_estado.place(x=270, y=110)

        self.l_local = Label(janela, text='Local*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_local.place(x=10, y=130)
        self.e_local = Entry(janela, width =48,justify='left',relief='solid')
        self.e_local.place(x=15, y=150)

        self.l_espaco = Label(janela, text='Espaço*', anchor=NW, font=('Ivy 10 bold'),bg=c01,fg=c04, relief='flat')
        self.l_espaco.place(x=10, y=170)
        self.e_espaco = Entry(janela, width =48,justify='left',relief='solid')
        self.e_espaco.place(x=15, y=190)
      
        self.l_tipo = Label(janela, text='Tipo*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_tipo.place(x=10, y=210)
        self.e_tipo = Entry(janela, width =25, justify='left',relief='solid')
        self.e_tipo.place(x=15, y=230)

        self.l_valor = Label(janela, text='Valor Ingresso*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_valor.place(x=190, y=210)
        self.e_valor = Entry(janela, width =17, justify='left',relief='solid')
        self.e_valor.place(x=200, y=230)
    ...
    def atualizar_tabela_evento(self):
        try:
            ...
            def update():    
                ...
                listaat = [valor_id,evento, data, cidade, estado, local, espaco, tipo, valor, descricao]
...
class agenda():
    ...
    def __init__(self):
        self.janela = janela
        self.tela_agenda()
        self.formulario_agenda()
        mostra_tabela_agenda()
        
        janela.mainloop()

    def conexao_tela_agenda(self):
        c = tela()
        self.janela_u = janela
        self.conexao_u = conexao
    ...
    def tela_agenda(self):
        ...
        self.frame_cima.grid(row=0, column=0) ###frame.cima
        ############### Inserindo formulario de Usuario ###############
        self.titulo_u = Label(janela, text='Agenda',anchor=NW, font=('Ivy 13 bold'), bg=c02,fg=c01, relief='flat')
        self.titulo_u.place(x=10, y=10)  

        self.b_inserir = Button(janela,command=self.inserir_agenda_tabela, text='Inserir',width =10, font=('Ivy 9 bold'), bg=c09,fg=c08,bd=3, relief='raised', overrelief='ridge')
        self.b_inserir.place(x=10, y=310)

        self.b_atualizar = Button(janela,command=self.atualizar_tabela_agenda, text='Atualizar', width =10, font=('Ivy 9 bold'),bg=c09,fg=c08,bd=3, relief='raised', overrelief='ridge')
        self.b_atualizar.place(x=110, y=310)

        self.b_deletar = Button(janela,command=self.deletar_tabela_agenda, text='Deletar', width =10, font=('Ivy 9 bold'),bg=c09,fg=c08,bd=3, relief='raised', overrelief='ridge')
        self.b_deletar.place(x=210, y=310)

        self.b_limpar = Button(janela,command=self.limpar_tela_agenda, text='Limpar', width =10, font=('Ivy 9 bold'),bg=c09,fg=c08,bd=3, relief='raised', overrelief='ridge')
        self.b_limpar.place(x=10, y=350)
    ...
    def formulario_agenda(self):  
        self.l_nome = Label(janela, text='Nome*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_nome.place(x=10, y=50)
        self.e_nome = Entry(janela , width =48, justify='left',relief='solid')
        self.e_nome.place(x=15, y=70)

        self.l_idusuario = Label(janela, text='ID Usuario*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_idusuario.place(x=10, y=90)
        self.e_idusuario = Entry(janela, width =12, justify='left',relief='solid')
        self.e_idusuario.place(x=15, y=110)

        self.l_idevento = Label(janela, text='ID Evento*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_idevento.place(x=115, y=90)
        self.e_idevento = Entry(janela, width =12,justify='left',relief='solid')
        self.e_idevento.place(x=120, y=110)

        self.l_idade = Label(janela, text='Idade*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_idade.place(x=220, y=90)
        self.e_idade = Entry(janela, width =13, justify='left',relief='solid')
        self.e_idade.place(x=225, y=110)

        self.l_email = Label(janela, text='E-mail*', anchor=NW, font=('Ivy 10 bold'), bg=c01,fg=c04, relief='flat')
        self.l_email.place(x=10, y=130)
        self.e_email = Entry(janela, width =48,justify='left',relief='solid')
        self.e_email.place(x=15, y=150)

    def limpar_tela_agenda(self):
        self.e_nome.delete(0, 'end')
        self.e_idusuario.delete(0, 'end')
        self.e_idevento.delete(0, 'end')
        self.e_idade.delete(0, 'end')
        self.e_email.delete(0, 'end')
   
    def inserir_agenda_tabela(self):
    ##### atualizar tabela #####
        nome = self.e_nome.get()
        idusuario= self.e_idusuario.get()
        idevento = self.e_idevento.get()
        idade = self.e_idade.get()
        email = self.e_email.get()
        
        idade = int(idade)

        lista = [nome, idusuario,idevento,idade,email]

        if (nome =='') or (idevento =='') or (idusuario =='') or (idade =='') or (email ==''):
            messagebox.showerror('Erro', 'O nenhum campo pode ser vazio!')

        elif idade <= 17:
            messagebox.showerror('Erro', 'Cadastro apenas para Maiores de 18 anos!')

        else:
            inserir_info_agenda(lista)    
            messagebox.showerror('Sucesso', "Os dados foram inseridos com sucesso!")
    ...
    def atualizar_tabela_agenda(self):
        try:
            treev_dados = tree.focus()
            treev_dicionario = tree.item(treev_dados)
            tree_lista = treev_dicionario['values']
            ...
            self.e_idusuario.insert(0, tree_lista[2])
            self.e_idevento.insert(0, tree_lista[3])
            self.e_idade.insert(0, tree_lista[4])
            self.e_email.insert(0, tree_lista[5])
        
            def update():    
                nome = self.e_nome.delete(0, 'end')
                idusuario= self.e_idusuario.delete(0, 'end')
                idevento = self.e_idevento.delete(0, 'end')
                idade = self.e_idade.delete(0, 'end')
                email = self.e_email.delete(0, 'end')
            
                
                lista = [valor_id,nome, idusuario,idevento,idade,email]
                #or logradouro or num or bairro or cep or cidade or estado or idade or genero or telefone or cpf or email
                if evento  == '':
                    messagebox.showerror('Erro', 'Nenhum campo não pode ser vario!')
    ...
    def deletar_tabela_agenda(self):
        try:
            treev_dados = tree.focus()
            treev_dicionario = tree.item(treev_dados)
            tree_lista = treev_dicionario['values']
...
def mostra_tabela_agenda():
    ...
    #********criando o visual da tabela a direita*******
        ...
        #Inserindo formulario de _evento
    cabecalho = ['ID','NOME', 'ID USUARIO', 'ID EVENTO', 'IDADE', 'E-MAIL']
